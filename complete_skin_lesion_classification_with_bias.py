...
# Evaluate models
dp_resnet18, eo_resnet18 = evaluate_bias(model_resnet18, test_loader, protected_attr_name='Sex')
dp_vgg16, eo_vgg16 = evaluate_bias(model_vgg16, test_loader, protected_attr_name='Sex')

print("Demographic Parity for ResNet18: ", dp_resnet18)
print("Equalized Odds for ResNet18: ", eo_resnet18)

print("Demographic Parity for VGG16: ", dp_vgg16)
print("Equalized Odds for VGG16: ", eo_vgg16)
